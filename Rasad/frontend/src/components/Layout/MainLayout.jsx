          ...
          <nav className="sidebar-nav">
            ...
            {user.role === 'owner' && (
              <>
                ...
                <Link to="/live-deliveries" className={`nav-item ${window.location.pathname === '/live-deliveries' ? 'active' : ''}`} onClick={closeSidebar}>
                  <span className="nav-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                  </span>
                  {t('Live Deliveries', 'براہ راست ترسیل')}
                </Link>
